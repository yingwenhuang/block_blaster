...
public class ImageText5 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < 10; i++)
        {
            ...
            if(op == 0)
            {
                adder1[i] = UnityEngine.Random.Range(1,10);
                adder2[i] = UnityEngine.Random.Range(1,10);
            ...
            {
                adder1[i] = UnityEngine.Random.Range(1,8);
                adder2[i] = UnityEngine.Random.Range(1,8);
                result[i] = (adder1[i] * adder2[i]).ToString();
                s1 = adder1[i].ToString();
                s2 = adder2[i].ToString();
                leftEquation[i] = "\t" + s1 + " \n*  " + s2;
    ...
    void Update()
    {
        ...
        if(numImagesLeft() == 0)
        {
            ...
            int temp = PlayerPrefs.GetInt("score5");
