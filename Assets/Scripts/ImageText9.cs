...
public class ImageText9 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for(int i = 0; i < 10; i++)
        {
            ...
            int op = UnityEngine.Random.Range(0,2);
            if(op == 0)
            {
                adder1[i] = UnityEngine.Random.Range(1,100);
                adder2[i] = UnityEngine.Random.Range(1,100-adder1[i]);
            ...
            else if(op == 1)
            {
                ...
                {
                    adder1[i] = UnityEngine.Random.Range(1,100);
                    adder2[i] = UnityEngine.Random.Range(1,100);
                    if(adder1[i] - adder2[i] >= 0)
                    {
                        done = true;
                        result[i] = (adder1[i] - adder2[i]).ToString();
                    }
    ...
    void Update()
    {
        ...
        if(numImagesLeft() == 0)
        {
            ...
            int temp = PlayerPrefs.GetInt("score9");
